      ...
      >
        <div className="flex flex-col justify-center h-full text-black text-9xl">
          ...
          >
            ...
            (Sony CSL – Paris), Sample Match, is the first AI-sample library
            that fits your musical context
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex flex-col w-full p-30 min-h-screen">
        ...
        >
          ...
          <div className="w-1/3 pr-10">
            ...
            <div>
              Built Python backend to query AI model, React/TS frontend,
              integrated OS sample library, managed and optimized large audio
              datasets.
            </div>
          </div>
          <div className="w-1/3">
