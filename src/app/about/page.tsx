        ...
        >
            ...
            >
                <div className="flex flex-col z-10">
                    ...
                    >
                        I’m a full-stack developer and a musician based in Paris
                        (as you can see in the photo), <br /> just out of five
                        years of intensive studies in software development.
                    </motion.div>
                </div>
            ...
            <div className="flex font-raleway w-full min-h-screen p-30">
                <div className="flex flex-col w-1/2">
                    ...
                    >
                        Right after high school, I was deeply into math and
                        algorithms, so I joined a Mathematics and Computer
                        Science program at Paris-Dauphine University.
                    </div>
            ...
            >
                <div className="flex flex-col w-1/2">
                    <div className="text-2xl font-raleway">
                        Since I was a kid, I’d had a musical project that
                        eventually took most of my time. I signed with Universal
                        and spent three years making music professionally,
                        discovering so much about the creative world along the
                        way.
                    </div>
            ...
            <div className="flex font-raleway w-full min-h-screen p-30">
                <div className="flex flex-col w-1/2">
                    <div className="text-2xl font-raleway">
                        Then came the lockdown, and with it, a growing
                        frustration. I felt I hadn’t fully explored what
                        technology could offer, both for music and beyond.
                        That’s when I truly discovered the world of web and
                        software development, which has since become a real
                        passion of mine.
                    </div>
