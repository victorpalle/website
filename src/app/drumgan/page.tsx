    ...
    return (
        ...
        >
            ...
            <div className="flex absolute top-10 right-10 text-black text-3xl font-raleway gap-3">
                <Link className='underline-hover' href="/drumgan">DrumGAN</Link>&#x2022;
                <Link className='underline-hover' href="/samplematch">Sample Match</Link>&#x2022;
                <Link className='underline-hover' href="/sonar">Sonar</Link>
            </div>
            ...
            >
                <div className="flex flex-col justify-center h-full text-black text-9xl">
                    ...
                    >
                        ...
                        Laboratories (Sony CSL – Paris), DrumGAN uses artificial
                        intelligence to make drum sound design faster and more
                        fun than before.
                    </motion.div>
                </div>
            </div>
            ...
            <div className="flex flex-col w-full p-30 min-h-screen">
                ...
                >
                    ...
                    <div className="w-1/3 pr-10">
                        ...
                        <div>
                            Created a Python API for Sony DrumGAN AI and a
                            React/TS frontend with Tone.js, handling
                            synchronized audio, animations, and a web drum
                            machine.
                        </div>
                    </div>
                    <div className="w-1/3">
            ...
            <div className="min-h-screen flex flex-col w-full px-30 pb-30 gap-30">
                <div
                    ...
                    style={{ color: colors.primary }}
                >
                    Built during my first internship on Sony CSL’s music team,
                    this prototype connects to the DrumGAN AI and lets me create
                    music interactively — it’s so good I still use it today !
                </div>
