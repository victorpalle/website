        ...
        >
            ...
            >
                <div className="flex flex-col justify-center h-full text-black text-9xl">
                    ...
                    >
                        Sonar was built by Goodwave, a startup connecting
                        patrons with associations.
                    </motion.div>
                </div>
            </div>
            ...
            <div className="flex flex-col w-full p-30 min-h-screen">
                ...
                >
                    ...
                    <div className="w-1/3 pr-10">
                        ...
                        <div>
                            Built the React frontend and login system with API
                            integration
                        </div>
                    </div>
                    <div className="w-1/3">
            ...
            <div className="min-h-screen flex flex-col w-full px-30 pb-30 gap-30">
                <div
                    ...
                    style={{ color: colors.primary }}
                >
                    Worked on Sonar during my first developer internship. I
                    learned all my React and NestJS fundamentals in this highly
                    formative project.
                </div>
                <div className="w-full flex justify-end">
                    <div
                        ...
                        style={{ color: colors.primary }}
                    >
                        It’s also where I learned the foundations of clean code,
                        testing, GitHub workflows, and collaborative development
