            ...
            <div className="flex min-h-screen w-full px-50">
                ...
                <div className="flex flex-col w-1/2 min-h-screen pt-70 font-raleway">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="text-black text-xl mt-10">
                            I bridge
                            music and technology, <br /> crafting creative interfaces
                            and robust architectures <br />I leverage AI to deliver
                            the best of technology to users, <br /> in the smartest and
                            most engaging ways
                        </div>
                    </div>
                </div>
                ...
                >
                    {menuItems.map((item, i) => (
                        ...
                        >
                            <Link href={item.href} className="underline-left-right text-black">
                                {item.label}
                            </Link>
                        </motion.div>
                    ))}
                </motion.div>
            <Image className='absolute right-0 top-[-100px] z-0' src="wave1.svg" width={500} height={400} alt="wave" />
            </div>
        </div>
    )
}
